        ...
        <Container disableGutters>
          <Grid container alignItems="center" style={{ marginBottom: 4 }}>
            <Typography style={{ fontSize: 12 }}>
              At RavenXAI, we value the privacy of our users. This privacy
            ...
            <ol style={{ listStyleType: 1 }} className={classes.orderedList}>
              ...
              <ul>
                ...
                When you create an account, we collect personal details such as
                your name, email address, and password.
                <li style={{ fontWeight: "bold" }}>Social Media Data</li>
                By connecting your Facebook and Instagram pages, we collect
                basic information from these platforms, including:
                <ul>
                  <li>Page details (page name, page ID, followers, etc.)</li>
                  <li>
                    Post and engagement metrics (likes, comments, shares, etc.)
                  </li>
                  <li>
                    Competitor page information if you add them for monitoring
                    purposes
                  </li>
                </ul>
              ...
              <li style={{ fontWeight: "bold", marginTop: "8px" }}>
              ...
              <ul>
                ...
                <li>
                  Generate and display social media analytics and competitor
                  data
                </li>
                <li>Improve our website's functionality and user experience</li>
                <li>Respond to customer service inquiries</li>
                <li>
                  Send occasional updates and notifications relevant to your
                  account
                </li>
              </ul>
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                providers necessary to operate RavenXAI (e.g., cloud storage
                providers). These third parties are obligated to maintain the
                confidentiality of your information and use it only for
                providing the services we require. We may also share data if
                required by law, to protect our legal rights, or in the event of
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                various measures to protect your personal information from
                unauthorized access, including encryption, secure servers, and
              ...
              <p style={{ textAlign: "justify" }}>
                ...
                usage data and enhance your experience on our website. You can
              ...
              <ul>
                ...
                <li>
                  ...
                  account and personal data from our systems.
                </li>
                <li>
              ...
              <strong>[info@ravenxai.com]</strong>.
              <li style={{ fontWeight: "bold", marginTop: "8px" }}>
                Third-Party Links
              </li>
              <p style={{ textAlign: "justify" }}>
                Our platform may contain links to third-party websites (such as
                Facebook and Instagram). We are not responsible for the privacy
                practices or content of these third-party sites. We encourage
              ...
              <p style={{ textAlign: "justify" }}>
                RavenXAI is not intended for use by individuals under the age of
