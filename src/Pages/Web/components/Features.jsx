        ...
        <div className="space-y-32 md:space-y-56 ">
          ...
          <div className="grid gap-4 md:grid-cols-2 md:gap-10">
            <div className="space-y-6 py-10 md:space-y-10">
              <Link
                to="/login"
                className="rounded-full border px-4 py-2 text-base font-normal"
              >
              ...
              <div className="space-y-6">
                ...
                <Link
                  to="/"
                  className="inline-block rounded-full bg-primary px-6 py-3 text-background"
                >
                  Learn More
                </Link>
              </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 md:gap-10">
            ...
            <div className="space-y-6 py-10 md:space-y-10">
              <Link
                to="/login"
                className="pointer-events-none invisible rounded-full border px-4 py-2 text-base font-normal"
              >
                More About My Social View
              </Link>
